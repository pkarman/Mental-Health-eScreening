...
$(document).ready(function() {
	...
	$('.selectAllModule').click(function(event) {  //on click 		
	...
	$('.selectAllClinic').click(function(event) {  //on click 		
		//alert( $(this).attr("data-cbgroup") );
        if(this.checked) { // check select status
            $(".checkbox_group_clinic").each(function() { //loop through each checkbox
                this.checked = true;  //select all checkboxes with class "checkbox_group"            
            });
        }else{
            $(".checkbox_group_clinic").each(function() { //loop through each checkbox
