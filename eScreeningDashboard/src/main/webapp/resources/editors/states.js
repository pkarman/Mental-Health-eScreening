                    ...
                    resolve : {
                        template: ['$rootScope', '$stateParams', '$q', 'TemplateService', function($rootScope, $stateParams, $q, TemplateService) {
                            ...
                            if(Object.isDefined($stateParams) 
                                ...
                                //uncomment as soon as we get the correct structure from the server
//                                if(Object.isDefined($stateParams.templateId) && $stateParams.templateId.length > 0){
//                                    console.log("Getting template from server with ID: " + $stateParams.templateId);
//                                    
//                                    TemplateService.one($stateParams.templateId).get().then(function (template) {
...
//                                                $rootScope.createErrorMessage(
//                                                        BytePushers.models.Message(
