            ...
            <div class="mainDiv">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-8">
                      <h2>Export Log <a href="exportData" class="btn btn-success btn-lg active  btn-xs" role="button"><span class="glyphicon glyphicon-refresh"></span> Refresh</a></h2>
                    </div>
                    <div class="col-md-4">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="alert alert-info">Please enter a comment for this export and click ok to download the export file. <br />
                Please do not do any operations while downland is in progress.</div>
              <div class="form-group">
      ...
      <div class="modal fade" id="modal_progress" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body"> <strong id="progressMessages"></strong>
              <div class="progress">
                <div class="progress-bar progress-bar-striped active"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 100%"> <span class="sr-only">100% Complete</span> </div>
              </div>
            </div>
          </div>
        </div>
