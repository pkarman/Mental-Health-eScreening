            ...
            <div class="col-md-12">
                ...
                <c:if test="${!isCprsVerified}">
                    <div class="alert alert-danger">
                        Your VistA account information needs to be verified before you can save or read any data from
                        VistA.
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <form:input path="lastName" maxlength="30" cssClass="form-control focus_input"
                                                cssErrorClass="form-control" placeholder="Enter Veteran Last Name"/>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <form:input path="ssnLastFour" maxlength="4" cssClass="form-control"
                                                cssErrorClass="form-control" placeholder="Enter Veteran Last SSN-4"/>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input id="searchButton" name="searchButton" value="Search" type="submit"
                    ...
                    <table class="table table-striped table-hover" summary="Search Result Table">
                        ...
                        <c:if test="${not empty searchResultList}">
                            <c:forEach var="item" items="${searchResultList}">
                                <tr>
                                    <td class="text-right"><c:if test="${item.isSensitive}"><c:out value="XXXX"/></c:if><c:if
                                            test="${!item.isSensitive}"><c:out value="${item.ssnLastFour}"/></c:if></td>
                                    <td><c:out value="${item.lastName}"/></td>
                                    <td><c:out value="${item.firstName}"/></td>
                                    <td><c:out value="${item.middleName}"/></td>
                                    <td class="text-right"><c:if test="${item.isSensitive}"><c:out value="XX/XX/XXXX"/></c:if><c:if
                                            test="${!item.isSensitive}"><fmt:formatDate type="date" pattern="MM/dd/yyyy"
                                                                                        value="${item.birthDate}"/></c:if></td>
                                    ...
                                    <td align="right">
                                        <s:url var="veteranDetailUrl" value="/dashboard/veteranDetail"
                                               htmlEscape="true">
                                            <s:param name="vid" value="${item.veteranId}"/>
                                            <s:param name="vien" value="${item.veteranIen}"/>
                                        </s:url>

                                        <a href="#" data-vid="${item.veteranId}" data-vien="${item.veteranIen}"
                                           class="btn btn-primary btn-xs push" data-toggle="modal"
                                           data-target="#myModal"><span
                                                class="glyphicon glyphicon-chevron-right"></span> Quick View</a>
                                        <a href="${veteranDetailUrl}" class="btn btn-primary btn-xs"><span
                                                class="glyphicon glyphicon-chevron-right"></span> Select</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:if>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mod_container quick_view">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div>Name (Last, First Middle)<br/> <strong> <span class="mod_fullName"></span> </strong>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div>SSN-4<br/> <strong><span class="mod_ssnLastFour"></span></strong></div>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div>Date of Birth<br/> <strong><span class="mod_birthDate"></span></strong></div>
                        </div>
                        <div class="col-md-2">
                            <div>Gender<br/> <strong><span class="mod_gender"></span></strong></div>
                        </div>
                        <div class="col-md-6">
                            <div>Email<br/><strong><span class="mod_email"></span></strong></div>
                        </div>
                    </div>
                    <hr/>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div>Phone<br/><strong><span class="mod_phone"></span></strong></div>
                        </div>
                        <div class="col-md-4">
                            <div>Best Time To Call<br/><strong><span class="mod_bestTimeToCall"></span></strong></div>
                        </div>
                        <div class="col-md-4">
                            <div>Best Time To Call Other<br/><strong><span
                                    class="mod_bestTimeToCallOther"></span></strong></div>
                        </div>
                    </div>
