    ...
    <c:forEach var="section" items="${sections}" varStatus ="status">
      <li>
        <div class="progressEntry">
          <div class="progressLabel"> <span for="progress_<c:out value="${section.surveySectionId}"/>" aria-label="<c:out value="${section.name}" />">
...
<div id="center" class="column contentAreaGrayRadial" aria-hidden="false"> <a name="skip" > </a >
  ...
  <div id="bottomNavigation" role="navigation" style="margin-top: -30px;">
    ...
    <button id="saveExitBtn" class="searchBtn" style="line-height:30px;"> <img src="../resources/css/icons/SaveGlyph.png" alt="Icon - Save and Exit" class="buttonIcon"> <span class="saveExitBtnText"> Save &amp; Exit</span> </button>
...
<div id="dialogRequired" class="hidden" title="Missing Required Fields" aria-hidden="true">
  <div class="dialogSkipInfo"
                ...
                role="alert"> Required inputs can not be empty. Required fields are denoted with an <span class="requiredIcon">* </span>in each required questions.
...
<div id="dialogLogoutTimer" class="hidden" title="Session will expire">
  <div class="sessionExpireContainer"> <span id="sessionExpireMessageLabel" class="sessionExpireMessageLabel"></span> <span id="counter"></span> <span class="sessionExpireMessageLabel">second(s).</span>
...
<div id="dialogTableQuestionEntryClicked" class="hidden" title="Unanswered Questions"  aria-hidden="true">
  <div class="dialogSkipInfo" title="Please answer each question before creating a new entry" aria-label="Please answer each question before creating a new entry"
               role="alert"> Please answer each question before creating a new entry </div>
</div>
</body>
</html>