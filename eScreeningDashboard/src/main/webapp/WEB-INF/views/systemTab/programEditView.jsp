          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="margin_top_10 checkbox_margin_right">
          ...
          <div class="row filter-panels"> 
            ...
            <div class="col-md-4">
              <div class="panel panel-primary">
                <div class="panel-heading">
                  <h2 class="panel-title"><label for="battery-list-table-filter">Battery</label><!--<form:label path="selectedBatteryIdList"></form:label>--></h2>
                  <div class="pull-right"> <span class="clickable filter" data-toggle="tooltip" title="Toggle Filter" data-container="body"> <span class="label label-info"><i class="glyphicon glyphicon-filter"></i> Filters</span> </span> </div>
                </div>
              ...
              <div class="panel panel-primary">
                <div class="panel-heading">
                  <h2 class="panel-title"><strong>
                    <label for="clinic-list-table-filter">VistA Clinic</label>
                    </strong><!-- <form:label path="selectedClinicIdList"></form:label>--></h2>
                  <div class="pull-right"> <span class="clickable filter" data-toggle="tooltip" title="Toggle Filter" data-container="body"> <span class="label label-info"><i class="glyphicon glyphicon-filter"></i> Filters</span> </span> </div>
                </div>
                <div class="panel-body">
            ...
            <div class="col-md-4">
              <div class="panel panel-primary">
                <div class="panel-heading">
                  <h2 class="panel-title"><strong>
                    <label for="note-list-table-filter">Note List</label>
                    </strong><!-- <form:label path="selectedClinicIdList"></form:label>--></h2>
                  <div class="pull-right"> <span class="clickable filter" data-toggle="tooltip" title="Toggle Filter" data-container="body"> <span class="label label-info"><i class="glyphicon glyphicon-filter"></i> Filters</span> </span> </div>
                </div>
                <div class="panel-body">
