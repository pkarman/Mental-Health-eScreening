 ...
 <#assign allAnswersNone = false> 
  ...
  <#assign Q2_isAnswerNone = false>
   ...
   <#if !Q3_isAnswerNone && (var5130.children)?? && (var5130.children)?has_content> 
   			...
   			<#if (v.children)?? > 
   				<#list v.children as c> 
   					<#if (c.row)??> 
   						...
   						<#assign end_months = ["var5100", "var5102", "var5103", "var5104", "var5105", "var5106", "var5107", "var5108", "var5109", "var5110", "var5111", "var5112"]>  
   		...
   		<#if uniqueRows?has_content>
    		...
    		<#list uniqueRows as r> 
    			...
    			<#if (loc?has_content) && (beg_month?has_content) && (beg_yr?has_content) && (end_month?has_content) && (end_yr?has_content)> ${innerNextLine}
    				<#assign all_rows = all_rows +	beg_month + "/" + beg_yr + "-"  + end_month + "/" + end_yr + ": "  + loc + " "> 
    ...
    <#if Q1_isAnswerNone && Q2_isAnswerNone && Q3_isAnswerNone> <#assign allAnswersNone = true> </#if>     
    	<#assign nextLine = ""> 
    	...
    	<#else> 
    		...
    		<#else> ${nextLine}The Veteran reported receiving the following personal awards or commendations: ${getSelectMultiDisplayText(var5020)}. 
    			<#assign nextLine = "${LINE_BREAK}${LINE_BREAK}"> 
    		</#if>   
