...
public class SurveyResponsesHelper {
	...
	public DataExportCell create(Map<String, String> usrRespMap,
			Map<String, String> aggregateMap, String colName, boolean show) {
		String colVal = usrRespMap == null ? null : usrRespMap.get(colName);
		return new DataExportCell(colName, getOrMiss(colVal == null ? aggregateMap.get(colName) : colVal));
	}
