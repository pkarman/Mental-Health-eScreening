...
public class Assessment implements Serializable {
	...
	public Assessment(SurveyPage surveyPage, boolean isFirstPage,
			boolean isLastPage, boolean isComplete) {
		if (surveyPage != null) {
			...
			if (surveyPage.getSurvey().getSurveySection() != null) {
				this.currentSurveySection = surveyPage.getSurvey()
	...
	public String toString() {
		return "Assessment [pageId=" + pageId + ", currentSurveyId="
				+ currentSurveyId + ", currentSurveyTitle="
				+ currentSurveyTitle + ", currentPage=" + currentPage
