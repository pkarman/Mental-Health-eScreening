...
public class VistaBrokerVistaLinkConnectionSpec
    ...
    public VistaBrokerVistaLinkConnectionSpec(
        ...
        try {
            this.avCode = VistaKernelHash.encrypt(accessCode + ";" + verifyCode + ";" + clientIp, true);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof VistaBrokerVistaLinkConnectionSpec) {
            ...
            VistaBrokerVistaLinkConnectionSpec connSpec = (VistaBrokerVistaLinkConnectionSpec) obj;
