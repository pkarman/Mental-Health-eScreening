...
public class AssessmentVariableController {
    ...
    //TODO: We only to access service via a business delegate.  Need to re-factor service class to not be injected; but a business delegate instead.
	...
	@ResponseBody
	public List getAssessmentVarsForSurvey(@RequestParam("surveyId") Integer surveyId) {
