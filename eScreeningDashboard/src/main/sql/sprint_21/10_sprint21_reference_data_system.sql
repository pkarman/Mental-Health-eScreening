...
ON DUPLICATE KEY UPDATE template_type_id=4, name='Note Special', description='Template used to generate a special section of a Note. Associated with a Battery.';
...
ON DUPLICATE KEY UPDATE template_type_id=5, name='Note Conclusion', description='Template used to generate the conclusion of a Note. Associated with a Battery.';

INSERT template_type (template_type_id, name, description) VALUES (6, 'Veteran Summary Entry', 'Template used to generate the body elements of a Veteran Summary Note. Associated with a Module.')
ON DUPLICATE KEY UPDATE template_type_id=3, name='Veteran Summary Entry',  description='Template used to generate the body elements of a Veteran Summary Note. Associated with a Module.';