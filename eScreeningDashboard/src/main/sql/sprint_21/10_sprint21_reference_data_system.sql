...
ON DUPLICATE KEY UPDATE template_type_id=6, name='Veteran Summary Printout Header',  description='Template used to generate the header element of a Veteran Summary Printout. Associated with a Battery.';
...
ON DUPLICATE KEY UPDATE template_type_id=7, name='Veteran Summary Printout Footer',  description='Template used to generate the footer element of a Veteran Summary Printout. Associated with a Battery.';
...
ON DUPLICATE KEY UPDATE template_type_id=8, name='Veteran Summary Printout Entry',  description='Template used to generate the body elements of a Veteran Summary Printout. Associated with a Module.';
...
ON DUPLICATE KEY UPDATE template_type_id=9, name='VistA Questions and Answers',  description='Template used to generate the VistA question and answer text which is included in the CPRS Note. Associated with a Module.';
