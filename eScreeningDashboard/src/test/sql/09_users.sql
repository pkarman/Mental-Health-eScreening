 ...
 * Note: any user with cprs_verified=1 will have their Vista credentials set to the proxy account
 */
...
VALUES(2,1,1,'evaladmin','5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8','One','M','EvalAdminOne','some@nowher.oro','some@nowher.oro','1234567890','1234567890', 1);
...
INSERT INTO user(user_id,role_id,user_status_id,login_id,password,first_name,middle_name,last_name,email_address,email_address2,phone_number,phone_number2, cprs_verified)
VALUES(6,4,1,'1radiologist','5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8','One','M','1radiologist','some@nowher.oro','some@nowher.oro','1234567890','1234567890', 1);
...
INSERT INTO user(user_id,role_id,user_status_id,login_id,password,first_name,middle_name,last_name,email_address,email_address2,phone_number,phone_number2, cprs_verified)
VALUES(8,5,1,'assistant','5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8','One','M','Assistant','some@nowher.oro','some@nowher.oro','1234567890','1234567890', 1);
