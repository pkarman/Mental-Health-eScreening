/*
XMLParser - an amplified XML parser in JavaScript,
based on JKL.ParseXML.
...
XMLParser = function ( url, query, method ) {
    // debug.print( "new XMLParser( '"+url+"', '"+query+"', '"+method+"' );" );
    this.http = new XMLParser.HTTP( url, query, method, false );
    return this;
};
...
XMLParser.VERSION = "0.22";
XMLParser.MIME_TYPE_XML  = "text/xml";
XMLParser.MAP_NODETYPE = [
    "",
    "ELEMENT_NODE",                 // 1
    "ATTRIBUTE_NODE",               // 2
    "TEXT_NODE",                    // 3
...
XMLParser.prototype.async = function ( func, args ) {
    this.callback_func = func;      // callback function
    this.callback_arg  = args;      // first argument
};

XMLParser.prototype.onerror = function ( func, args ) {
...
XMLParser.prototype.parseResponse = function () {
...
XMLParser.prototype.parseDocument = function ( root ) {
...
XMLParser.prototype.parseElement = function ( elem ) {
    // debug.print( "nodeType: "+XMLParser.MAP_NODETYPE[elem.nodeType]+" <"+elem.nodeName+">" );
...
XMLParser.Text = function ( url, query, method ) {
    // debug.print( "new XMLParser.Text( '"+url+"', '"+query+"', '"+method+"' );" );
    this.http = new XMLParser.HTTP( url, query, method, true );
    return this;
};

XMLParser.Text.prototype.parse = XMLParser.prototype.parse;
XMLParser.Text.prototype.async = XMLParser.prototype.async;
XMLParser.Text.prototype.onerror = XMLParser.prototype.onerror;

XMLParser.Text.prototype.parseResponse = function () {
    var data = this.http.responseText();
    return data;
}

// ================================================================
//  class: XMLParser.JSON

XMLParser.JSON = function ( url, query, method ) {
    // debug.print( "new XMLParser.JSON( '"+url+"', '"+query+"', '"+method+"' );" );
    this.http = new XMLParser.HTTP( url, query, method, true );
    return this;
};

XMLParser.JSON.prototype.parse = XMLParser.prototype.parse;
XMLParser.JSON.prototype.async = XMLParser.prototype.async;
XMLParser.JSON.prototype.onerror = XMLParser.prototype.onerror;

XMLParser.JSON.prototype.parseResponse = function () {
...
XMLParser.DOM = function ( url, query, method ) {
    // debug.print( "new XMLParser.DOM( '"+url+"', '"+query+"', '"+method+"' );" );
    this.http = new XMLParser.HTTP( url, query, method, false );
    return this;
};

XMLParser.DOM.prototype.parse = XMLParser.prototype.parse;
XMLParser.DOM.prototype.async = XMLParser.prototype.async;
XMLParser.DOM.prototype.onerror = XMLParser.prototype.onerror;

XMLParser.DOM.prototype.parseResponse = function () {
...
XMLParser.CSV = function ( url, query, method ) {
    // debug.print( "new XMLParser.CSV( '"+url+"', '"+query+"', '"+method+"' );" );
    this.http = new XMLParser.HTTP( url, query, method, true );
    return this;
};

XMLParser.CSV.prototype.parse = XMLParser.prototype.parse;
XMLParser.CSV.prototype.async = XMLParser.prototype.async;
XMLParser.CSV.prototype.onerror = XMLParser.prototype.onerror;

XMLParser.CSV.prototype.parseResponse = function () {
    var text = this.http.responseText();
    var data = this.parseCSV( text );
    return data;
}

XMLParser.CSV.prototype.parseCSV = function ( text ) {
    text = text.replace( /\r\n?/g, "\n" );              // new line character
    var pos = 0;
    var len = text.length;
    var table = [];
...
// ================================================================
//  class: XMLParser.CSVmap

XMLParser.CSVmap = function ( url, query, method ) {
    // debug.print( "new XMLParser.CSVmap( '"+url+"', '"+query+"', '"+method+"' );" );
    this.http = new XMLParser.HTTP( url, query, method, true );
    return this;
};

XMLParser.CSVmap.prototype.parse = XMLParser.prototype.parse;
XMLParser.CSVmap.prototype.async = XMLParser.prototype.async;
XMLParser.CSVmap.prototype.onerror = XMLParser.prototype.onerror;
XMLParser.CSVmap.prototype.parseCSV = XMLParser.CSV.prototype.parseCSV;

XMLParser.CSVmap.prototype.parseResponse = function () {
    var text = this.http.responseText();
...
// ================================================================
//  class: XMLParser.LoadVars

XMLParser.LoadVars = function ( url, query, method ) {
    // debug.print( "new XMLParser.LoadVars( '"+url+"', '"+query+"', '"+method+"' );" );
    this.http = new XMLParser.HTTP( url, query, method, true );
    return this;
};

XMLParser.LoadVars.prototype.parse = XMLParser.prototype.parse;
XMLParser.LoadVars.prototype.async = XMLParser.prototype.async;
XMLParser.LoadVars.prototype.onerror = XMLParser.prototype.onerror;

XMLParser.LoadVars.prototype.parseResponse = function () {
    var text = this.http.responseText();
    text = text.replace( /\r\n?/g, "\n" );              // new line character
    var hash = {};
    var list = text.split( "&" );
...
// ================================================================
//  class: XMLParser.HTTP
//  constructer: new XMLParser.HTTP()

XMLParser.HTTP = function( url, query, method, textmode ) {
    // debug.print( "new XMLParser.HTTP( '"+url+"', '"+query+"', '"+method+"', '"+textmode+"' );" );
    this.url = url;
...
XMLParser.HTTP.REQUEST_TYPE  = "application/x-www-form-urlencoded";
XMLParser.HTTP.ACTIVEX_XMLDOM  = "Microsoft.XMLDOM";  // Msxml2.DOMDocument.5.0
XMLParser.HTTP.ACTIVEX_XMLHTTP = "Microsoft.XMLHTTP"; // Msxml2.XMLHTTP.3.0
XMLParser.HTTP.EPOCH_TIMESTAMP = "Thu, 01 Jun 1970 00:00:00 GMT"

// ================================================================

XMLParser.HTTP.prototype.onerror = XMLParser.prototype.onerror;
XMLParser.HTTP.prototype.async = function( func ) {
...
XMLParser.HTTP.prototype.load = function() {
    // create XMLHttpRequest object
    if ( window.ActiveXObject ) {                           // IE5.5,6,7
        var activex = XMLParser.HTTP.ACTIVEX_XMLHTTP;    // IXMLHttpRequest
        if ( this.method == "GET" && ! this.textmode ) {
            ...
            activex = XMLParser.HTTP.ACTIVEX_XMLDOM;     // IXMLDOMElement
        }
...
//      // debug.print( "If-Modified-Since"+XMLParser.HTTP.EPOCH_TIMESTAMP );
//      this.req.setRequestHeader( "If-Modified-Since", XMLParser.HTTP.EPOCH_TIMESTAMP );
//  }

    // Content-Type: application/x-www-form-urlencoded (request header)
    // Some server does not accept without request content-type.
    if ( typeof(this.req.setRequestHeader) != "undefined" ) {
        // debug.print( "Content-Type: "+XMLParser.HTTP.REQUEST_TYPE+" (request)" );
        this.req.setRequestHeader( "Content-Type", XMLParser.HTTP.REQUEST_TYPE );
    }
    ...
    if ( typeof(this.req.overrideMimeType) != "undefined" && ! this.textmode ) {
        // debug.print( "Content-Type: "+XMLParser.MIME_TYPE_XML+" (response)" );
        this.req.overrideMimeType( XMLParser.MIME_TYPE_XML );
    }
...
XMLParser.HTTP.prototype.checkResponse = function() {
...
XMLParser.HTTP.prototype.documentElement = function() {
...
XMLParser.HTTP.prototype.responseText = function() {
