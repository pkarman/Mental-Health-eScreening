...
abstract class Resolver {
    ...
    protected final void addSingleRow(Survey s, Measure m, Multimap mvMap,
        ...
        boolean isMultiSelect = m.getMeasureType().getMeasureTypeId().equals(MeasureTypeEnum.SELECTMULTI.getMeasureTypeId()) || m.getMeasureType().getMeasureTypeId().equals(MeasureTypeEnum.SELECTMULTIMATRIX.getMeasureTypeId());
        addRow(t, rowId, quesType, isMultiSelect, quesDesc, varName, valsRange, valsDesc, dataVal, followup, skiplevel, other);
    }
    ...
    protected String generateRowId(String partialRowId, String salt, int index) {
        ...
        //return rowId;
        return String.format("%s_%s_%s", ddh.EXPORT_KEY_PREFIX, partialRowId, System.nanoTime());
    }

    protected void addRow(DataDictionarySheet t, String rowId,
                          String quesType, boolean multiSelect, String quesDesc, String varName, String valsRange,
                          String valsDesc, String dataVal, String followup, String skiplevel, boolean other) {

        t.put(rowId, ddh.msg("ques.type"), quesType);
        t.put(rowId, ddh.msg("ques.multi.select"), String.valueOf(multiSelect));
...
class TableQuestionResolver extends SelectOneMatrixResolver {
    ...
    protected void addDictionaryRowsNow(Survey s, Measure m, Multimap mvMap,
        ...
        addRow(t, generateRowId("", saltForResponseRowCounter, 0), "tableResponseCntr", false, "total responses of table questions", tableResponsesCounterVarName, "", "", "", "", "", false);
        super.addDictionaryRowsNow(s, m, mvMap, t, salt);
    }
}
