 ...
 */
EScreeningDashboardApp.models.MenuItemSurveySectionWrapper = function (surveySection) {
    if (!Object.isDefined(surveySection)) {
        throw new Error("SurveySection can not be null and has to be defined.");
    }

    if (!typeof surveySection === "object" && !surveySection instanceof EScreeningDashboardApp.models.SurveySection) {
        throw new Error("SurveySection has to be of type EScreeningDashboardApp.models.SurveyQuestion.");
    }

    this.item = surveySection;
