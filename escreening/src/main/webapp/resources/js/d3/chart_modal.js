$(document).ready(function() {        
    /* IN PROGRESS TO USE IN ASSESSMENT SUMMARY */
	$(this).on("click", '#VeteranSummaryButton', function(e){
        e.preventDefault();
		if(typeof vaid === 'undefined' || vaid == ''){ vaid	= getParameterByName('vaid'); };
		if(typeof vid === 'undefined' || vid == ''){ vid = getParameterByName('vid'); };
