...
<div class="container left-right-shadow">
  <div class="row">
    <div class="col-md-4 pull-right">
      ...
      <a href="${addProgramUrl}" class="btn btn-primary btn-md form-control h1_button"><span class="glyphicon glyphicon-plus"></span> Add New Program</a> </div>
    <div class="col-md-8 pull-left"><a name="skip" > </a >
      <h1>Program List View</h1>
    </div>
  </div>
    ...
    <table class="table table-striped table-hover" summary="Program List View">
      ...
      <c:forEach var="item" items="${programList}">
        <tr>
          ...
          <td class="text-right"><s:url var="editProgramUrl" value="/dashboard/programEditView" htmlEscape="true">
              <s:param name="pid" value="${item.programId}" />
            </s:url>
            <a href="${editProgramUrl}" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-chevron-right"></span> Edit </a></td>
        </tr>
      </c:forEach>
    </table>
  </div>
...
<script type="text/javascript" src="<c:url value="/resources/js/dashboard/programListView.js?v=1" />"></script>
</html>
