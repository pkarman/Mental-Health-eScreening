        ...
        <div class="container left-right-shadow nonPrintableArea">
            <form:form modelAttribute="assessmentSummaryFormBean" autocomplete="off" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <div class="text-right h1_align"><strong>Current Status: </strong> <span
                                class="label label-success">${veteranAssessmentInfo.assessmentStatusName}</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <c:if test="${!isCprsVerified}">
                            <div class="alert alert-danger"> Your VistA account information needs to be verified before
                                you can save
                        ...
                        <div class="border-radius-main-form">
                                    ...
                                    <div class="txt_lable_lg">
                                        ...
                                        <c:if test="${!veteranAssessmentInfo.isSensitive}">
                                            <fmt:formatDate type="date" pattern="MM/dd/yyyy"
                                                            value="${veteranAssessmentInfo.birthDate}"/>
                                        </c:if>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2 text-right"> VistA IEN
                                    ...
                                    <c:if test="${isCprsVerified}">
                                        <c:if test="${empty veteranAssessmentInfo.veteranIen}">
                                            <s:url var="mapVeteranToVistaUrl" value="/dashboard/mapVeteranToVistaRecord"
                                                   htmlEscape="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2"> Date Created
                                    <div class="txt_lable_md">
                                        <fmt:formatDate type="date" pattern="MM/dd/yyyy HH:mm:ss"
                                                        value="${veteranAssessmentInfo.dateCreated}"/>
                                    </div>
                                </div>
                                <div class="col-md-2"> Date Completed
                                    <div class="txt_lable_md">
                                        <fmt:formatDate type="date" pattern="MM/dd/yyyy HH:mm:ss"
                                                        value="${veteranAssessmentInfo.dateCompleted}"/>
                                    </div>
                                </div>
                                <div class="col-md-4 text-right"> Veteran Summary
                                    <div class="txt_lable_md"><a href="#" data-toggle="modal" id="VeteranSummaryButton">View
                                        Veteran
                                        Summary</a></div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="reviewAssessmentButton" name="reviewAssessmentButton"
                                               value="Review Assessment"
                                               type="button" class="btn btn-primary" data-toggle="modal"
                                               data-target="#assessment_reminders_modal"/>
                                        <c:if test="${not empty veteranAssessmentInfo.veteranIen}">
                                            <c:if test="${isCprsVerified}">
                                                <input id="saveToVistaModal" name="saveToVistaModal"
                                                       value="Save To VistA"
                                                       type="button" class="btn btn-primary" data-toggle="modal"
                                                       data-target="#save_to_vista_modal"
                                                       <c:if test="${veteranAssessmentInfo.assessmentStatusName != 'Complete'}">disabled="disabled"</c:if> />
                                            </c:if>
                                            <c:if test="${!isCprsVerified}">
                                                <input id="saveToVistaModal" name="saveToVistaModal"
                                                       value="Save To VistA"
                                        ...
                                        <input id="healthFactorTitlesButton" name="healthFactorTitlesButton"
                                               value="Health Factor Titles" type="button" class="btn btn-primary"
                                               data-toggle="modal" data-target="health_factor_titles_modal"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group text-right">
                                        <input id="saveButton" name="saveButton" value="Save" type="submit"
                                               class="btn btn-primary"/>
                                        <input id="cancelButton" name="cancelButton" value="Cancel" type="submit"
                                               class="btn btn-default btn-default-black"/>
                                    </div>
                                </div>
                            </div>

                            <!-- Modal Save to VistA -->
                            <div class="modal fade" id="save_to_vista_modal" tabindex="-1" role="dialog"
                                 aria-labelledby="save_to_vista_modal_label" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="alert alert-warning">Are you sure you want to Save Data to
                                                VistA?
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <input id="saveToVistaButton" name="saveToVistaButton" value="Save"
                                                   type="submit"
                                                   class="btn btn-primary"/>
            ...
            <div class="custom_modal veteran_summary_modal">
                <div class="modal fade  modal-wide" id="VeteranSummaryModal" tabindex="-1" role="dialog"
                     aria-labelledby="VeteranSummaryModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body printableArea">
                                <div align="right" class="nonPrintableArea">
                                    <button class="btn btn-primary print"><span
            ...
            <div class="custom_modal">
                <div class="modal fade modal-wide" id="AssessmentReportPreview" tabindex="-1" role="dialog"
                     aria-labelledby="AssessmentReportPreview" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header nonPrintableArea">
                                <button type="button" class="close" data-dismiss="modal"
            ...
            <div class="modal fade" id="healthFactorTitles" tabindex="-1" role="dialog"
                 aria-labelledby="healthFactorTitles"
                 aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header nonPrintableArea">
